...
Register a handler in the game-system plugin. Handlers translate a keyword into modifiers on named channels, so the engine does not see the keyword itself.
