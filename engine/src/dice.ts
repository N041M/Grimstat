...
/**
 * Mean of the distribution `dicePMF` builds. The bonus is floored at zero per roll rather than on
 * the total, so "D6-2" has mean 1.667. Closed form unless the roll can reach the floor.
 */
