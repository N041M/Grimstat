...
export type Route = "calculator" | "scenarios" | "armies" | "codex" | "analyses" | "battle" | "play" | "data" | "about";
export const ROUTES: Route[] = ["calculator", "scenarios", "armies", "codex", "analyses", "battle", "play", "data", "about"];
