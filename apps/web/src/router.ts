...
export type Route = "calculator" | "scenarios" | "armies" | "collection" | "codex" | "analyses" | "battle" | "play" | "data" | "about";
export const ROUTES: Route[] = ["calculator", "scenarios", "armies", "collection", "codex", "analyses", "battle", "play", "data", "about"];
