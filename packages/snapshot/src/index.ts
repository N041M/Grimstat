...
export { mergeSources, mergeOntoBase, BASE_ADAPTER, DEFAULT_MERGE_POLICY } from "./merge";
export type { MergeBase, MergePart, MergePolicy, MergeResult, PartialDatasheet, Unmatched } from "./merge";
