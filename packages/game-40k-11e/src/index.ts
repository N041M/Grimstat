...
export { makeScenario, runMatrix, durabilityProfile, durabilityIndex, efficiencyRanking } from "./analysis";
export type { MatrixResult, MatrixCell, DurabilityEntry, DurabilityIndexRow, EfficiencyRow } from "./analysis";
